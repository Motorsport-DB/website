<?php
$pageTitle = 'Driverdle F1 - Daily F1 Driver Comparison Game';
$pageDescription = 'Guess today\'s F1 driver by comparing properties: career years, teams, wins, age and more. Unlimited tries.';
...
<main class="flex-grow container mx-auto px-4 py-8 flex flex-col items-center space-y-6">
  ...
  <div class="max-w-5xl w-full bg-white dark:bg-gray-900 rounded-xl shadow p-4 sm:p-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
      <h2 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Driverdle F1 🏎️</h2>
      <span class="text-sm text-gray-500 dark:text-gray-400">Unlimited guesses · New driver every day</span>
    </div>
    <p class="text-sm text-gray-600 dark:text-gray-400">Guess today's F1 driver. Compare your guess with the target using the colored hints below.</p>
  </div>

  <!-- Game area -->
  <div id="comparison-game" data-mode="f1" class="max-w-5xl w-full space-y-4">

    <!-- Search -->
    <div id="search-container" class="bg-white dark:bg-gray-900 rounded-xl shadow p-4 relative">
      <label for="driver-search" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Search an F1 driver</label>
      <div class="relative">
        <input id="driver-search" type="text" autocomplete="off" spellcheck="false"
          placeholder="e.g. Hamilton, Verstappen…"
  ...
  <div class="max-w-5xl w-full bg-white dark:bg-gray-900 rounded-xl shadow p-4 sm:p-6">
    ...
    <ul class="text-sm text-gray-700 dark:text-gray-300 space-y-1 list-disc list-inside">
      <li>Search and select any F1 driver who started at least one Race.</li>
    ...
    <ul class="text-sm text-gray-700 dark:text-gray-300 space-y-1 list-disc list-inside">
      <li><strong>1st F1 Year</strong> — year of first F1 Race start. Orange if within ±3 years.</li>
      <li><strong>Last F1 Year</strong> — year of most recent F1 Race. Orange if within ±3 years.</li>
      <li><strong>Teams</strong> — all constructors raced with in F1. Orange if ≥1 team in common.</li>
      <li><strong>F1 Wins</strong> — total F1 Race victories. Orange if within ±10 wins.</li>
      ...
      <li><strong>Other Series</strong> — non-F1 championships raced in during or after the F1 career. Orange if ≥1 in common.</li>
    </ul>
  </div>
