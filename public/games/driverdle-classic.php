<?php
$pageTitle = 'Driverdle Classic - Daily Driver Name Guessing';
$pageDescription = 'Classic Wordle-style: guess the motorsport driver\'s last name in 6 tries.';
...
<script src="/assets/js/games/driverdle-classic.js"></script>
